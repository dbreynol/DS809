...
5. Suppose you aim to estimate $\mathbf{\phi}$ for an AR(2) model in which $\hat{\mathbf{\gamma}} = (2.1,1.5,1.3)$. What is the Yule-Walker estimate for $\mathbf{\phi}$ and also for $\sigma$?

6. Set up the likelihood function for and AR(p) model