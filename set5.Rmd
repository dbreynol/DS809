...
Let's look at this concept at work with a dynamic regression model. We will use the `Seatbelts` dataset and fit a model using `y=DriversKilled` and `x = PetrolPrice`. The model we will fit is:
